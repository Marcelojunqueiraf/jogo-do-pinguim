COMPONENTES=Componentes/Sprite/Sprite.cpp Componentes/Component/Component.cpp Componentes/Sound/Sound.cpp Componentes/TileMap/TileMap.cpp Componentes/CameraFollower/CameraFollower.cpp Componentes/Alien/Alien.cpp Componentes/Minion/Minion.cpp
